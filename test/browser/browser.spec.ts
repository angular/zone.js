...
describe('Zone', function() {
  ...
  describe('hooks', function() {
    it('should allow you to override alert/prompt/confirm', function() {
      ...
      const spies: {
        [k: string]: Function;
      } = {alert: alertSpy, prompt: promptSpy, confirm: confirmSpy};
    ...
    describe(
      ...
      ifEnvSupports(canPatchOnProperty(HTMLElement.prototype, 'onclick'), function() {
        ...
        it(
          'window onclick should be in zone',
        ...
        it(
          'document onclick should be in zone',
        ...
        it(
          ...
          ifEnvSupports(canPatchOnProperty(Document.prototype, 'onmousedown'), function() {
            ...
            if (EventTarget) {
              ...
              (HTMLSpanElement.prototype as any)[
                '__zone_symbol__addEventListener'
              ] = oriAddEventListener;
            }
          })
        ...
        it(
          'SVGElement onclick should be in zone',
          ifEnvSupports(
    ...
    describe('eventListener hooks', function() {
      ...
      it(
        'should support add multipe listeners with AddEventListenerOptions once setting and same capture after normal listener',
        ifEnvSupports(supportEventListenerOptions, function() {
          let logs: string[] = [];
      ...
      it(
        'should support add multipe listeners with AddEventListenerOptions once setting and mixed capture after normal listener',
        ifEnvSupports(supportEventListenerOptions, function() {
          let logs: string[] = [];
      ...
      it(
        'should support add multipe listeners with AddEventListenerOptions once setting before normal listener',
        ifEnvSupports(supportEventListenerOptions, function() {
          let logs: string[] = [];
      ...
      it(
        'should support add multipe listeners with AddEventListenerOptions once setting with same capture before normal listener',
        ifEnvSupports(supportEventListenerOptions, function() {
          let logs: string[] = [];
      ...
      it(
        'should support add multipe listeners with AddEventListenerOptions once setting with mixed capture before normal listener',
        ifEnvSupports(supportEventListenerOptions, function() {
          let logs: string[] = [];
